...
def generate_launch_description():
    ...
    pkg_bme_gazebo_sensors = get_package_share_directory('robot_manager')

    gazebo_models_path, ignore_last_dir = os.path.split(pkg_bme_gazebo_sensors)
    os.environ["GZ_SIM_RESOURCE_PATH"] += os.pathsep + gazebo_models_path


    # pkg_robot_manager = get_package_share_directory('robot_manager')
    # meshes_path = os.path.join(pkg_robot_manager, 'meshes')

    # # Se GZ_SIM_RESOURCE_PATH esiste, aggiungi la cartella; altrimenti creala
    # if "GZ_SIM_RESOURCE_PATH" in os.environ:
    #     os.environ["GZ_SIM_RESOURCE_PATH"] += os.pathsep + meshes_path
    # else:
    ...
    # the path to your URDF or Xacro file
    ...
    launchDescriptionObject.add_action(base_footprint_tf)
    launchDescriptionObject.add_action(gz_bridge_node)
    launchDescriptionObject.add_action(gz_image_bridge_node)
    # launchDescriptionObject.add_action(delayed_ekf)
