...
def generate_launch_description():
    ...
    pkg_robot_manager = FindPackageShare('robot_manager')
    default_rviz_config_path = PathJoinSubstitution([pkg_robot_manager, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the robot_manager package
